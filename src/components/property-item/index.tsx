...
const PropertyItem: React.FC<PropertyItemProps> = ({ image, title }) => {
	...
	return (
		<div
			...
			className="overflow-hidden shadow-lg min-w-[26rem] min-h-[15rem] rounded-lg flex items-end relative before:content-[''] w-full h-full bg-black"
		>
			<h1 className="text-white font-bold text-lg p-3 z-10 font-['Inter']">
				{title}
			</h1>
